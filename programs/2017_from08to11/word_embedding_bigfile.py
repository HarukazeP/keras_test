...
#読み込むもの
train_path = '../WikiSentWithEndMark1.txt'     #学習データ
...
f_emb=Embedding(output_dim=128, input_dim=len_words+1, input_length=maxlen_words, mask_zero=True)(f_input)

f_layer=LSTM(128)(f_emb)

r_input=Input(shape=(maxlen_words,))
r_emb=Embedding(output_dim=128, input_dim=len_words+1, input_length=maxlen_words, mask_zero=True)(r_input)
